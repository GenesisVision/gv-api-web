...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.ManagersList();
  });
  ...
  describe('ManagersList', function() {
    it('should create an instance of ManagersList', function() {
      // uncomment below and update the code to test ManagersList
      //var instance = new CoreApiV10.ManagersList();
      //expect(instance).to.be.a(CoreApiV10.ManagersList);
    });
