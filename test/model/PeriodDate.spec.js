...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.PeriodDate();
  });
  ...
  describe('PeriodDate', function() {
    it('should create an instance of PeriodDate', function() {
      // uncomment below and update the code to test PeriodDate
      //var instance = new CoreApiV10.PeriodDate();
      //expect(instance).to.be.a(CoreApiV10.PeriodDate);
    });
