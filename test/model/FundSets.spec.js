...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.FundSets();
  });
  ...
  describe('FundSets', function() {
    it('should create an instance of FundSets', function() {
      // uncomment below and update the code to test FundSets
      //var instance = new CoreApiV10.FundSets();
      //expect(instance).to.be.a(CoreApiV10.FundSets);
    });
