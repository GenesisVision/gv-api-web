...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.WalletDeposit();
  });
  ...
  describe('WalletDeposit', function() {
    it('should create an instance of WalletDeposit', function() {
      // uncomment below and update the code to test WalletDeposit
      //var instane = new CoreApiV10.WalletDeposit();
      //expect(instance).to.be.a(CoreApiV10.WalletDeposit);
    });
