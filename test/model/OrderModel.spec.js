...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApi.OrderModel();
  });
  ...
  describe('OrderModel', function() {
    it('should create an instance of OrderModel', function() {
      ...
      //var instane = new CoreApi.OrderModel();
      //expect(instance).to.be.a(CoreApi.OrderModel);
    });
    ...
    it('should have the property priceOpen (base name: "priceOpen")', function() {
