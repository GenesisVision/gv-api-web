...
export class AssetsApi {
    ...
    closeTradingAccount(id, authorization) {
        return this.closeTradingAccountWithHttpInfo(id, authorization)
            .then(function (response_and_data) {
            return response_and_data.data;
        });
    }
    closeTradingAccountWithHttpInfo(id, authorization) {
        let postBody = null;
        if (id === undefined || id === null) {
        ...
        let accepts = ["text/plain", "application/json", "text/json"];
        let returnType = null;
        return this.apiClient.callApi('/v2.0/assets/tradingaccounts/{id}/close', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType);
    }
    ...
    makeDemoTradingAccountDeposit(id, authorization, opts) {
        return this.makeDemoTradingAccountDepositWithHttpInfo(id, authorization, opts)
            .then(function (response_and_data) {
            return response_and_data.data;
        });
    }
    makeDemoTradingAccountDepositWithHttpInfo(id, authorization, opts = {}) {
        let postBody = opts["model"];
        if (id === undefined || id === null) {
        ...
        let accepts = ["text/plain", "application/json", "text/json"];
        let returnType = null;
        return this.apiClient.callApi('/v2.0/assets/tradingaccounts/{id}/demo/deposit', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType);
    }
