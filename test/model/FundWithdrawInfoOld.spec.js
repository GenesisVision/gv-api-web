...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.FundWithdrawInfoOld();
  });
  ...
  describe('FundWithdrawInfoOld', function() {
    it('should create an instance of FundWithdrawInfoOld', function() {
      // uncomment below and update the code to test FundWithdrawInfoOld
      //var instane = new CoreApiV10.FundWithdrawInfoOld();
      //expect(instance).to.be.a(CoreApiV10.FundWithdrawInfoOld);
    });
