...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CoreApiV10.ProgramFacet = factory(root.CoreApiV10.ApiClient);
  }
  ...
  /**
   * The ProgramFacet model module.
   * @module model/ProgramFacet
   * @version v1.0
   */

  /**
   * Constructs a new <code>ProgramFacet</code>.
   * @alias module:model/ProgramFacet
   * @class
   */
  ...
  /**
   * Constructs a <code>ProgramFacet</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ProgramFacet} obj Optional instance to populate.
   * @return {module:model/ProgramFacet} The populated <code>ProgramFacet</code> instance.
   */
  ...
  /**
   * @member {module:model/ProgramFacet.SortingEnum} sorting
   */
  ...
  /**
   * @member {module:model/ProgramFacet.SortTypeEnum} sortType
   */
  exports.prototype['sortType'] = undefined;
  /**
   * @member {module:model/ProgramFacet.TimeframeEnum} timeframe
   */
