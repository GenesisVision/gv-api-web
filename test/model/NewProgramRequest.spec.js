...
(function(root, factory) {
  ...
  describe('NewProgramRequest', function() {
    ...
    it('should have the property tradingPlatformId (base name: "tradingPlatformId")', function() {
      // uncomment below and update the code to test the property tradingPlatformId
      //var instane = new CoreApiV10.NewProgramRequest();
      //expect(instance).to.be();
    });
