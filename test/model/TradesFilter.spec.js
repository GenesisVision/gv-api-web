...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApi.TradesFilter();
  });
  ...
  describe('TradesFilter', function() {
    it('should create an instance of TradesFilter', function() {
      // uncomment below and update the code to test TradesFilter
      //var instane = new CoreApi.TradesFilter();
      //expect(instance).to.be.a(CoreApi.TradesFilter);
    });
