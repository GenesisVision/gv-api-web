...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.BalanceChartElement();
  });
  ...
  describe('BalanceChartElement', function() {
    it('should create an instance of BalanceChartElement', function() {
      // uncomment below and update the code to test BalanceChartElement
      //var instance = new CoreApiV10.BalanceChartElement();
      //expect(instance).to.be.a(CoreApiV10.BalanceChartElement);
    });
