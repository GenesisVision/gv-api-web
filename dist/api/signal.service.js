...
export class SignalService {
    ...
    getCopytradingAccountsWithHttpInfo(authorization) {
        ...
        return this.apiClient.callApi('/v2.0/signal/accounts', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType);
    }
    ...
    getSignalsWithHttpInfo(opts = {}) {
        ...
        return this.apiClient.callApi('/v2.0/signal', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType);
    }
    ...
    getSlaveAttachInfoWithHttpInfo(id, authorization) {
        ...
        return this.apiClient.callApi('/v2.0/signal/attach/{id}/info', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType);
    }
