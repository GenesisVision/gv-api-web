...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.ChartFundDetails();
  });
  ...
  describe('ChartFundDetails', function() {
    it('should create an instance of ChartFundDetails', function() {
      // uncomment below and update the code to test ChartFundDetails
      //var instane = new CoreApiV10.ChartFundDetails();
      //expect(instance).to.be.a(CoreApiV10.ChartFundDetails);
    });
