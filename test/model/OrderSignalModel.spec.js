...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.OrderSignalModel();
  });
  ...
  describe('OrderSignalModel', function() {
    it('should create an instance of OrderSignalModel', function() {
      // uncomment below and update the code to test OrderSignalModel
      //var instance = new CoreApiV10.OrderSignalModel();
      //expect(instance).to.be.a(CoreApiV10.OrderSignalModel);
    });

    it('should have the property tradingFee (base name: "tradingFee")', function() {
      // uncomment below and update the code to test the property tradingFee
      //var instance = new CoreApiV10.OrderSignalModel();
