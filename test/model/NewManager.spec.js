...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.NewManager();
  });
  ...
  describe('NewManager', function() {
    it('should create an instance of NewManager', function() {
      // uncomment below and update the code to test NewManager
      //var instane = new CoreApiV10.NewManager();
      //expect(instance).to.be.a(CoreApiV10.NewManager);
    });
