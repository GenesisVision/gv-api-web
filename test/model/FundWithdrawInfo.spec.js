...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.FundWithdrawInfo();
  });
  ...
  describe('FundWithdrawInfo', function() {
    it('should create an instance of FundWithdrawInfo', function() {
      // uncomment below and update the code to test FundWithdrawInfo
      //var instance = new CoreApiV10.FundWithdrawInfo();
      //expect(instance).to.be.a(CoreApiV10.FundWithdrawInfo);
    });
