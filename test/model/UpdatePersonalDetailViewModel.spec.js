...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.UpdatePersonalDetailViewModel();
  });
  ...
  describe('UpdatePersonalDetailViewModel', function() {
    it('should create an instance of UpdatePersonalDetailViewModel', function() {
      // uncomment below and update the code to test UpdatePersonalDetailViewModel
      //var instance = new CoreApiV10.UpdatePersonalDetailViewModel();
      //expect(instance).to.be.a(CoreApiV10.UpdatePersonalDetailViewModel);
    });
