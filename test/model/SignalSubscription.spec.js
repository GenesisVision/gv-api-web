...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.SignalSubscription();
  });
  ...
  describe('SignalSubscription', function() {
    it('should create an instance of SignalSubscription', function() {
      // uncomment below and update the code to test SignalSubscription
      //var instance = new CoreApiV10.SignalSubscription();
      //expect(instance).to.be.a(CoreApiV10.SignalSubscription);
    });
