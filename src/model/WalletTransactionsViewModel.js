...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/WalletTransaction'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./WalletTransaction'));
  } else {
    // Browser globals (root is window)
    if (!root.CoreApiV10) {
      root.CoreApiV10 = {};
    }
    root.CoreApiV10.WalletTransactionsViewModel = factory(root.CoreApiV10.ApiClient, root.CoreApiV10.WalletTransaction);
  }
}(this, function(ApiClient, WalletTransaction) {
  'use strict';
