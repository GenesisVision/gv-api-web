...
export class ProgramsInfoOld { 
    public 'managerProgramInvestment'?: number;
    public 'managerProgramInvestmentUSD'?: number;
    public 'managerProgramInvestmentUSDT'?: number;
    public 'managerProgramInvestmentBTC'?: number;
    public 'managerProgramInvestmentETH'?: number;
    public 'managerMaxEntryFee'?: number;
    public 'managerMaxSuccessFee'?: number;
    public 'managerFundInvestment'?: number;
    public 'managerMaxExitFee'?: number;
    public 'managerMaxSignalVolumeFee'?: number;
    ...
    static constructFromObject(data: {[key: string]: any}, obj: ProgramsInfoOld = new ProgramsInfoOld()): ProgramsInfoOld {
        if (data) {
