...
export class RateApi {
  ...
  public getRate(from: string, to: string): CancelablePromise<RateModel>{
  ...
  private getRateWithHttpInfo(from: string, to: string){
    ...
    return this.apiClient.callApi<RateModel>(
      '/v2.0/rate/{from}/{to}', 'GET',
  ...
  public getRateExchange(exchange: string, from: string, to: string): CancelablePromise<RateModel>{
  ...
  private getRateExchangeWithHttpInfo(exchange: string, from: string, to: string){
    ...
    return this.apiClient.callApi<RateModel>(
      '/v2.0/rate/{exchange}/{from}/{to}', 'GET',
      pathParams, queryParams, headerParams, formParams, postBody,
      authNames, contentTypes, accepts, returnType
    );
