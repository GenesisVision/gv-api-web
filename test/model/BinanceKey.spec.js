...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.BinanceKey();
  });
  ...
  describe('BinanceKey', function() {
    it('should create an instance of BinanceKey', function() {
      // uncomment below and update the code to test BinanceKey
      //var instane = new CoreApiV10.BinanceKey();
      //expect(instance).to.be.a(CoreApiV10.BinanceKey);
    });
