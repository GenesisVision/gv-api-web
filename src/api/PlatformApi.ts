...
import { PushNotificationViewModel } from '../model/PushNotificationViewModel';
...
export default class PlatformApi {
  ...
  getMsgForSignature = (
    ...
    init: RequestInit = {}): Promise<SignMessage> => {
    
    return generateMethod<Promise<SignMessage>>({
        init,
        queryParams: {  type: options['type']  },
        apiClient: this.apiClient,
        path: "/v2.0/platform/signature/message",
  ...
  getPlatformTime = (
    ...
    init: RequestInit = {}): Promise<PushNotificationViewModel> => {
    
    return generateMethod<Promise<PushNotificationViewModel>>({
        init,
        apiClient: this.apiClient,
        path: "/v2.0/platform/time",
