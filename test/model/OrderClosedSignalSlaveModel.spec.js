...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.OrderClosedSignalSlaveModel();
  });
  ...
  describe('OrderClosedSignalSlaveModel', function() {
    it('should create an instance of OrderClosedSignalSlaveModel', function() {
      // uncomment below and update the code to test OrderClosedSignalSlaveModel
      //var instane = new CoreApiV10.OrderClosedSignalSlaveModel();
      //expect(instance).to.be.a(CoreApiV10.OrderClosedSignalSlaveModel);
    });
    ...
    it('should have the property priceClose (base name: "priceClose")', function() {
