...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.InvestInfo();
  });
  ...
  describe('InvestInfo', function() {
    it('should create an instance of InvestInfo', function() {
      // uncomment below and update the code to test InvestInfo
      //var instane = new CoreApiV10.InvestInfo();
      //expect(instance).to.be.a(CoreApiV10.InvestInfo);
    });
