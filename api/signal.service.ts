...
export class SignalService {
  ...
  private attachSlaveCommonToMasterWithHttpInfo(id: string, authorization: string, opts: { 
    model?: AttachToExternalSignalProviderCommon
  } = {}){
  ...
  private attachSlaveToMaster_1WithHttpInfo(id: string, authorization: string, opts: { 
    model?: AttachToExternalSignalProviderExt
  } = {}){
    let postBody = opts["model"];
    ...
    return this.apiClient.callApi<null>(
      '/v2.0/signal/external/attach/{id}/external', 'POST',
      pathParams, queryParams, headerParams, formParams, postBody,
      authNames, contentTypes, accepts, returnType
    );
  ...
  public createExternalSignalAccount(authorization: string, opts?: { 
  ...
  private createExternalSignalAccountWithHttpInfo(authorization: string, opts: { 
    request?: NewExternalSignalAccountRequest
  } = {}){
    ...
    return this.apiClient.callApi<ProgramCreateResult>(
      '/v2.0/signal/external/create', 'POST',
      pathParams, queryParams, headerParams, formParams, postBody,
      authNames, contentTypes, accepts, returnType
    );
  ...
  public getExternalSignalTradingLog(authorization: string, opts?: { 
    accountId?: string, 
  ...
  private getExternalSignalTradingLogWithHttpInfo(authorization: string, opts: { 
    accountId?: string, 
    accountCurrency?: 'Undefined' | 'GVT' | 'ETH' | 'BTC' | 'ADA' | 'USDT' | 'XRP' | 'BCH' | 'LTC' | 'DOGE' | 'BNB' | 'USD' | 'EUR', 
    skip?: number, 
    take?: number
    ...
    return this.apiClient.callApi<SignalTradingEvents>(
      '/v2.0/signal/external/trades/log', 'GET',
      pathParams, queryParams, headerParams, formParams, postBody,
      authNames, contentTypes, accepts, returnType
    );
  ...
  private getSlaveAttachInfoWithHttpInfo(id: string, authorization: string){
    ...
    return this.apiClient.callApi<AttachToSignalProviderInfo>(
      '/v2.0/signal/attach/{id}/info', 'GET',
      pathParams, queryParams, headerParams, formParams, postBody,
      authNames, contentTypes, accepts, returnType
    );
