...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.ProgramWithdrawInfoOld();
  });
  ...
  describe('ProgramWithdrawInfoOld', function() {
    it('should create an instance of ProgramWithdrawInfoOld', function() {
      // uncomment below and update the code to test ProgramWithdrawInfoOld
      //var instane = new CoreApiV10.ProgramWithdrawInfoOld();
      //expect(instance).to.be.a(CoreApiV10.ProgramWithdrawInfoOld);
    });
