...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.ProgramTransactionDetails();
  });
  ...
  describe('ProgramTransactionDetails', function() {
    it('should create an instance of ProgramTransactionDetails', function() {
      // uncomment below and update the code to test ProgramTransactionDetails
      //var instance = new CoreApiV10.ProgramTransactionDetails();
      //expect(instance).to.be.a(CoreApiV10.ProgramTransactionDetails);
    });
    ...
    it('should have the property successFeeCurrency (base name: "successFeeCurrency")', function() {
      // uncomment below and update the code to test the property successFeeCurrency
      //var instance = new CoreApiV10.ProgramTransactionDetails();
      //expect(instance).to.be();
    });
