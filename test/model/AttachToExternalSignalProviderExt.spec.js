...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.AttachToExternalSignalProviderExt();
  });
  ...
  describe('AttachToExternalSignalProviderExt', function() {
    it('should create an instance of AttachToExternalSignalProviderExt', function() {
      // uncomment below and update the code to test AttachToExternalSignalProviderExt
      //var instane = new CoreApiV10.AttachToExternalSignalProviderExt();
      //expect(instance).to.be.a(CoreApiV10.AttachToExternalSignalProviderExt);
    });
