...
(function(root, factory) {
  ...
  describe('NewFundRequest', function() {
    ...
    it('should have the property tradingServerId (base name: "tradingServerId")', function() {
      // uncomment below and update the code to test the property tradingServerId
      //var instane = new CoreApiV10.NewFundRequest();
      //expect(instance).to.be();
    });
