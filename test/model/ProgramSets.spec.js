...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.ProgramSets();
  });
  ...
  describe('ProgramSets', function() {
    it('should create an instance of ProgramSets', function() {
      // uncomment below and update the code to test ProgramSets
      //var instance = new CoreApiV10.ProgramSets();
      //expect(instance).to.be.a(CoreApiV10.ProgramSets);
    });
