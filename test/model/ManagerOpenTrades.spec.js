...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApi.ManagerOpenTrades();
  });
  ...
  describe('ManagerOpenTrades', function() {
    it('should create an instance of ManagerOpenTrades', function() {
      // uncomment below and update the code to test ManagerOpenTrades
      //var instane = new CoreApi.ManagerOpenTrades();
      //expect(instance).to.be.a(CoreApi.ManagerOpenTrades);
    });
