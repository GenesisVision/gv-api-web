...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApi.BrokersFilter();
  });
  ...
  describe('BrokersFilter', function() {
    it('should create an instance of BrokersFilter', function() {
      // uncomment below and update the code to test BrokersFilter
      //var instane = new CoreApi.BrokersFilter();
      //expect(instance).to.be.a(CoreApi.BrokersFilter);
    });
    ...
    it('should have the property tradeServerName (base name: "tradeServerName")', function() {
      // uncomment below and update the code to test the property tradeServerName
      //var instane = new CoreApi.BrokersFilter();
      //expect(instance).to.be();
    });
