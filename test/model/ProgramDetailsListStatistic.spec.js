...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.ProgramDetailsListStatistic();
  });
  ...
  describe('ProgramDetailsListStatistic', function() {
    it('should create an instance of ProgramDetailsListStatistic', function() {
      ...
      //var instane = new CoreApiV10.ProgramDetailsListStatistic();
      //expect(instance).to.be.a(CoreApiV10.ProgramDetailsListStatistic);
    });

    it('should have the property balanceInBase (base name: "balanceInBase")', function() {
      // uncomment below and update the code to test the property balanceInBase
      //var instane = new CoreApiV10.ProgramDetailsListStatistic();
