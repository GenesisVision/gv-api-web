...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.SearchViewModel();
  });
  ...
  describe('SearchViewModel', function() {
    it('should create an instance of SearchViewModel', function() {
      // uncomment below and update the code to test SearchViewModel
      //var instance = new CoreApiV10.SearchViewModel();
      //expect(instance).to.be.a(CoreApiV10.SearchViewModel);
    });
