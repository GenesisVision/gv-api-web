...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.ProgramCreateResult();
  });
  ...
  describe('ProgramCreateResult', function() {
    it('should create an instance of ProgramCreateResult', function() {
      // uncomment below and update the code to test ProgramCreateResult
      //var instane = new CoreApiV10.ProgramCreateResult();
      //expect(instance).to.be.a(CoreApiV10.ProgramCreateResult);
    });
