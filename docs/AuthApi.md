...
------------- | ------------- | -------------
[**authorizeInvestor**](AuthApi.md#authorizeInvestor) | **POST** /v1.0/auth/signin/investor | Authorize
[**authorizeManager**](AuthApi.md#authorizeManager) | **POST** /v1.0/auth/signin/manager | Authorize
...
[**forgotPasswordInvestor**](AuthApi.md#forgotPasswordInvestor) | **POST** /v1.0/auth/password/forgot/investor | Forgot password for investor
[**forgotPasswordManager**](AuthApi.md#forgotPasswordManager) | **POST** /v1.0/auth/password/forgot/manager | Forgot password for manager
...
[**registerInvestor**](AuthApi.md#registerInvestor) | **POST** /v1.0/auth/signup/investor | New investor registration
[**registerManager**](AuthApi.md#registerManager) | **POST** /v1.0/auth/signup/manager | New manager registration
...
<a name="authorizeInvestor"></a>
# **authorizeInvestor**
> &#39;String&#39; authorizeInvestor(opts)
...
apiInstance.authorizeInvestor(opts).then((data) => {
...
apiInstance.authorizeManager(opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
<a name="forgotPasswordInvestor"></a>
# **forgotPasswordInvestor**
...
apiInstance.forgotPasswordInvestor(opts).then(() => {
...
<a name="forgotPasswordManager"></a>
...
apiInstance.forgotPasswordManager(opts).then(() => {
  console.log('API called successfully.');
}, (error) => {
  console.error(error);
});
...
apiInstance.registerInvestor(opts).then(() => {
  console.log('API called successfully.');
}, (error) => {
  console.error(error);
});
...
apiInstance.registerManager(opts).then(() => {
  console.log('API called successfully.');
}, (error) => {
  console.error(error);
});
