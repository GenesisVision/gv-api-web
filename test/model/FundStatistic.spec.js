...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.FundStatistic();
  });
  ...
  describe('FundStatistic', function() {
    it('should create an instance of FundStatistic', function() {
      // uncomment below and update the code to test FundStatistic
      //var instance = new CoreApiV10.FundStatistic();
      //expect(instance).to.be.a(CoreApiV10.FundStatistic);
    });
