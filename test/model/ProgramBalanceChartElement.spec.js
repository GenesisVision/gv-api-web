...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.ProgramBalanceChartElement();
  });
  ...
  describe('ProgramBalanceChartElement', function() {
    it('should create an instance of ProgramBalanceChartElement', function() {
      // uncomment below and update the code to test ProgramBalanceChartElement
      //var instance = new CoreApiV10.ProgramBalanceChartElement();
      //expect(instance).to.be.a(CoreApiV10.ProgramBalanceChartElement);
    });
