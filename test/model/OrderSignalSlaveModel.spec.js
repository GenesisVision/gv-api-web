...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.OrderSignalSlaveModel();
  });
  ...
  describe('OrderSignalSlaveModel', function() {
    it('should create an instance of OrderSignalSlaveModel', function() {
      // uncomment below and update the code to test OrderSignalSlaveModel
      //var instane = new CoreApiV10.OrderSignalSlaveModel();
      //expect(instance).to.be.a(CoreApiV10.OrderSignalSlaveModel);
    });
