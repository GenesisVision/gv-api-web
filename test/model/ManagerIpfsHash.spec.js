...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.ManagerIpfsHash();
  });
  ...
  describe('ManagerIpfsHash', function() {
    it('should create an instance of ManagerIpfsHash', function() {
      // uncomment below and update the code to test ManagerIpfsHash
      //var instane = new CoreApiV10.ManagerIpfsHash();
      //expect(instance).to.be.a(CoreApiV10.ManagerIpfsHash);
    });
