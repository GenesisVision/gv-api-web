...
export declare class ProgramsApi {
    ...
    exportProgramTrades(id: string, opts?: {
        ...
        accountId?: string;
        accountCurrency?: 'USD' | 'USDT' | 'Undefined' | 'GVT' | 'ETH' | 'BTC' | 'ADA' | 'XRP' | 'BCH' | 'LTC' | 'DOGE' | 'BNB' | 'EUR';
        isFollow?: boolean;
        skip?: number;
        take?: number;
    }): CancelablePromise<Blob>;
    ...
    getPrograms(opts?: {
        ...
        tags?: Array<string>;
        programCurrency?: 'USD' | 'USDT' | 'Undefined' | 'GVT' | 'ETH' | 'BTC' | 'ADA' | 'XRP' | 'BCH' | 'LTC' | 'DOGE' | 'BNB' | 'EUR';
        levelMin?: number;
        levelMax?: number;
