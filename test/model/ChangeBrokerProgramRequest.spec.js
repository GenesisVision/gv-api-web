...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.ChangeBrokerProgramRequest();
  });
  ...
  describe('ChangeBrokerProgramRequest', function() {
    it('should create an instance of ChangeBrokerProgramRequest', function() {
      // uncomment below and update the code to test ChangeBrokerProgramRequest
      //var instance = new CoreApiV10.ChangeBrokerProgramRequest();
      //expect(instance).to.be.a(CoreApiV10.ChangeBrokerProgramRequest);
    });
