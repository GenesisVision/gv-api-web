...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.SignalAccountDetails();
  });
  ...
  describe('SignalAccountDetails', function() {
    it('should create an instance of SignalAccountDetails', function() {
      // uncomment below and update the code to test SignalAccountDetails
      //var instane = new CoreApiV10.SignalAccountDetails();
      //expect(instance).to.be.a(CoreApiV10.SignalAccountDetails);
    });
