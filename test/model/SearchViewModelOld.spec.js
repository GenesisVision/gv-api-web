...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.SearchViewModelOld();
  });
  ...
  describe('SearchViewModelOld', function() {
    it('should create an instance of SearchViewModelOld', function() {
      // uncomment below and update the code to test SearchViewModelOld
      //var instane = new CoreApiV10.SearchViewModelOld();
      //expect(instance).to.be.a(CoreApiV10.SearchViewModelOld);
    });
