...
export class NotificationsApi {
  ...
  public readAllNotification(authorization: string): CancelablePromise<null>{
  ...
  private readAllNotificationWithHttpInfo(authorization: string){
    let postBody = null;
    ...
    return this.apiClient.callApi<null>(
      '/v2.0/notifications/all/read', 'POST',
      pathParams, queryParams, headerParams, formParams, postBody,
      authNames, contentTypes, accepts, returnType
    );
