...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.NewTradeEvent();
  });
  ...
  describe('NewTradeEvent', function() {
    it('should create an instance of NewTradeEvent', function() {
      // uncomment below and update the code to test NewTradeEvent
      //var instane = new CoreApiV10.NewTradeEvent();
      //expect(instance).to.be.a(CoreApiV10.NewTradeEvent);
    });
