...
import OrderClosedSignalSlaveModel from './OrderClosedSignalSlaveModel';
...
export default class TradesHistorySignalSlaveViewModel {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('trades')) {
                obj['trades'] = ApiClient.convertToType(data['trades'], [OrderClosedSignalSlaveModel]);
            }
