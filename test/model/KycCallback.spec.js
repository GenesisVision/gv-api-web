...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.KycCallback();
  });
  ...
  describe('KycCallback', function() {
    it('should create an instance of KycCallback', function() {
      // uncomment below and update the code to test KycCallback
      //var instane = new CoreApiV10.KycCallback();
      //expect(instance).to.be.a(CoreApiV10.KycCallback);
    });
    ...
    it('should have the property inspectionId (base name: "inspectionId")', function() {
      // uncomment below and update the code to test the property inspectionId
      //var instane = new CoreApiV10.KycCallback();
      //expect(instance).to.be();
    });
