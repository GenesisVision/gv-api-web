...
[**fundInvest**](ManagerApi.md#fundInvest) | **POST** /v1.0/manager/funds/{id}/invest/{amount} | Deposit.  Invest in GVT if currency is empty
...
[**fundWithdraw**](ManagerApi.md#fundWithdraw) | **POST** /v1.0/manager/funds/{id}/withdraw/{percent} | Withdraw from fund. Percent is % of manager total money.  Withdraw in GVT if currency is empty
...
[**managerAssets**](ManagerApi.md#managerAssets) | **GET** /v1.0/manager/assets | Manager assets list
...
[**programInvest**](ManagerApi.md#programInvest) | **POST** /v1.0/manager/programs/{id}/invest/{amount} | Deposit  Invest in GVT if currency is empty
[**programWithdraw**](ManagerApi.md#programWithdraw) | **POST** /v1.0/manager/programs/{id}/withdraw/multi/{amount} | Withdraw from investment program in program currency
...
<a name="managerAssets"></a>
# **managerAssets**
> ManagerAssets managerAssets(authorization)
...
apiInstance.managerAssets(authorization).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
# **managerFunds**
> FundsListOld managerFunds(authorization, opts)
...
# **managerPrograms**
> ProgramsListOld managerPrograms(authorization, opts)
