...
/**
* The InvestmentProgramDashboardInvestor model module.
* @module model/InvestmentProgramDashboardInvestor
* @version v1
*/
var InvestmentProgramDashboardInvestor = function () {
    /**
    * Constructs a new <code>InvestmentProgramDashboardInvestor</code>.
    * @alias module:model/InvestmentProgramDashboardInvestor
    * @class
    */

    function InvestmentProgramDashboardInvestor() {
        _classCallCheck(this, InvestmentProgramDashboardInvestor);
    ...
    /**
    * Constructs a <code>InvestmentProgramDashboardInvestor</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/InvestmentProgramDashboardInvestor} obj Optional instance to populate.
    * @return {module:model/InvestmentProgramDashboardInvestor} The populated <code>InvestmentProgramDashboardInvestor</code> instance.
    */


    _createClass(InvestmentProgramDashboardInvestor, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new InvestmentProgramDashboardInvestor();
                ...
                if (data.hasOwnProperty('isArchived')) {
                    obj['isArchived'] = _ApiClient2.default.convertToType(data['isArchived'], 'Boolean');
                }
        ...
        */
        ...
        /**
        * @member {module:model/InvestmentProgramDashboardInvestor.CurrencyEnum} currency
        */
        ...
        */
        ...
        /**
        * @member {module:model/InvestmentProgramDashboardInvestor.ProfitTotalChangeEnum} profitTotalChange
        */
    ...
    return InvestmentProgramDashboardInvestor;
}();

InvestmentProgramDashboardInvestor.CurrencyEnum = {
...
InvestmentProgramDashboardInvestor.ProfitTotalChangeEnum = {
...
exports.default = InvestmentProgramDashboardInvestor;