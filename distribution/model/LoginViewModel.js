...
var _CaptchaCheckResult = require('./CaptchaCheckResult');
...
var LoginViewModel = function () {
    function LoginViewModel(email, password) {
        ...
        this.captchaCheckResult = undefined;
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('captchaCheckResult')) {
                    obj['captchaCheckResult'] = _CaptchaCheckResult2.default.constructFromObject(data['captchaCheckResult']);
                }
            }
            return obj;
        }
