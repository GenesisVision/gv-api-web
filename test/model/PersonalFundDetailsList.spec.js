...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.PersonalFundDetailsList();
  });
  ...
  describe('PersonalFundDetailsList', function() {
    it('should create an instance of PersonalFundDetailsList', function() {
      // uncomment below and update the code to test PersonalFundDetailsList
      //var instane = new CoreApiV10.PersonalFundDetailsList();
      //expect(instance).to.be.a(CoreApiV10.PersonalFundDetailsList);
    });
