...
export default class ApiClient {
    ...
    basePath: string = 'https://localhost/api'.replace(/\/+$/, '');
    ...
    buildCollectionParam(param?: Array<any>, collectionFormat?: string): string | null | string[] {        if (param === null || param === undefined) {
            return null;
        }
     ...
     */
    applyAuthToRequest(request: SuperAgentRequest, authNames: string[]) {
     ...
     */
    deserialize(response?: superagent.Response, returnType?: any) {
        ...
        var data: ReadableStream | null | string = response.body;
        //@ts-ignore
    ...
    callApi<T>(path: string, httpMethod: "GET" | "POST" | "PUT" | "DELETE", pathParams: { [key: string]: number | string | Date | boolean  },
               ...
               accepts: string[],
               returnType: any): CancelablePromise<CallApiResponse<T>> {
        ...
        return new CancelablePromise<CallApiResponse<T>>((resolve, reject) => {
     ...
     */
    static convertToType(data: any, type: 'boolean' | 'integer' | 'number' | 'string' | 'Date' | 'Blob' | object | any) {
     ...
     */
    static constructFromObject(data: any, obj: any, itemType: any) {
