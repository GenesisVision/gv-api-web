...
/**
 *
 * @interface EventItemFiltersOld
 */

/**
 *
 * @name EventItemFiltersOld#programDetails
 * @type {Array<FilterModelOld>}
 */
/**
 *
 * @name EventItemFiltersOld#fundDetails
 * @type {Array<FilterModelOld>}
 */
/**
 *
 * @name EventItemFiltersOld#allAssets
 * @type {Array<FilterModelOld>}
 */
...
export default class EventItemFiltersOld {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventItemFiltersOld();
