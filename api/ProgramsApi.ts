...
export class ProgramsApi {
  ...
  public getProgramAbsoluteProfitChart(id: string, opts?: { 
    dateFrom?: Date, 
    dateTo?: Date, 
  ...
  private getProgramAbsoluteProfitChartWithHttpInfo(id: string, opts: { 
    dateFrom?: Date, 
    dateTo?: Date, 
    maxPointCount?: number, 
    currency?: 'BTC' | 'ETH' | 'USDT' | 'USD' | 'GVT' | 'Undefined' | 'ADA' | 'XRP' | 'BCH' | 'LTC' | 'DOGE' | 'BNB' | 'EUR'
    ...
    return this.apiClient.callApi<AbsoluteProfitChart>(
      '/v2.0/programs/{id}/charts/profit/absolute', 'GET',
      pathParams, queryParams, headerParams, formParams, postBody,
      authNames, contentTypes, accepts, returnType
    );
  ...
  public getProgramProfitPercentCharts(id: string, opts?: { 
    authorization?: string, 
    dateFrom?: Date, 
    dateTo?: Date, 
    maxPointCount?: number, 
  ...
  private getProgramProfitPercentChartsWithHttpInfo(id: string, opts: { 
    authorization?: string, 
    dateFrom?: Date, 
    dateTo?: Date, 
    maxPointCount?: number, 
    ...
    return this.apiClient.callApi<ProgramProfitPercentCharts>(
      '/v2.0/programs/{id}/charts/profit/percent', 'GET',
      pathParams, queryParams, headerParams, formParams, postBody,
      authNames, contentTypes, accepts, returnType
    );
  ...
  private getProgramsWithHttpInfo(opts: { 
    ...
    return this.apiClient.callApi<ItemsViewModelProgramDetailsListItem>(
      '/v2.0/programs', 'GET',
      pathParams, queryParams, headerParams, formParams, postBody,
      authNames, contentTypes, accepts, returnType
    );
