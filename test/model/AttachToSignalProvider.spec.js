...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.AttachToSignalProvider();
  });
  ...
  describe('AttachToSignalProvider', function() {
    it('should create an instance of AttachToSignalProvider', function() {
      // uncomment below and update the code to test AttachToSignalProvider
      //var instance = new CoreApiV10.AttachToSignalProvider();
      //expect(instance).to.be.a(CoreApiV10.AttachToSignalProvider);
    });
    ...
    it('should have the property initialDepositCurrency (base name: "initialDepositCurrency")', function() {
      // uncomment below and update the code to test the property initialDepositCurrency
      //var instance = new CoreApiV10.AttachToSignalProvider();
      //expect(instance).to.be();
    });

    it('should have the property initialDepositAmount (base name: "initialDepositAmount")', function() {
      // uncomment below and update the code to test the property initialDepositAmount
      //var instance = new CoreApiV10.AttachToSignalProvider();
      //expect(instance).to.be();
    });
