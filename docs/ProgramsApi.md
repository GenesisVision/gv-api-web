...
------------- | ------------- | -------------
[**facetsProgramsByIdGet**](ProgramsApi.md#facetsProgramsByIdGet) | **GET** /facets/programs/{id} | 
...
<a name="facetsProgramsByIdGet"></a>
# **facetsProgramsByIdGet**
> ProgramsList facetsProgramsByIdGet(id, opts)
...
apiInstance.facetsProgramsByIdGet(id, opts).then((data) => {
