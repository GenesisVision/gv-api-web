...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.SignalDataMaster();
  });
  ...
  describe('SignalDataMaster', function() {
    it('should create an instance of SignalDataMaster', function() {
      // uncomment below and update the code to test SignalDataMaster
      //var instance = new CoreApiV10.SignalDataMaster();
      //expect(instance).to.be.a(CoreApiV10.SignalDataMaster);
    });
