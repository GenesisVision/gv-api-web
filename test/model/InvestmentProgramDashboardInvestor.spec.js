...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApi.InvestmentProgramDashboardInvestor();
  });
  ...
  describe('InvestmentProgramDashboardInvestor', function() {
    it('should create an instance of InvestmentProgramDashboardInvestor', function() {
      // uncomment below and update the code to test InvestmentProgramDashboardInvestor
      //var instane = new CoreApi.InvestmentProgramDashboardInvestor();
      //expect(instance).to.be.a(CoreApi.InvestmentProgramDashboardInvestor);
    });
