...
export declare class ProgramsApi {
    ...
    exportProgramTrades(id: string, opts?: {
        ...
        accountId?: string;
        accountCurrency?: 'USD' | 'BTC' | 'Undefined' | 'GVT' | 'ETH' | 'ADA' | 'USDT' | 'XRP' | 'BCH' | 'LTC' | 'DOGE' | 'BNB' | 'EUR';
        skip?: number;
        take?: number;
    }): CancelablePromise<Blob>;
    ...
    getPrograms(opts?: {
        ...
        showIn?: 'USD' | 'BTC' | 'Undefined' | 'GVT' | 'ETH' | 'ADA' | 'USDT' | 'XRP' | 'BCH' | 'LTC' | 'DOGE' | 'BNB' | 'EUR';
        tags?: Array<string>;
        programCurrency?: 'USD' | 'BTC' | 'Undefined' | 'GVT' | 'ETH' | 'ADA' | 'USDT' | 'XRP' | 'BCH' | 'LTC' | 'DOGE' | 'BNB' | 'EUR';
        levelMin?: number;
        levelMax?: number;
