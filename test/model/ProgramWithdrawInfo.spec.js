...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.ProgramWithdrawInfo();
  });
  ...
  describe('ProgramWithdrawInfo', function() {
    it('should create an instance of ProgramWithdrawInfo', function() {
      // uncomment below and update the code to test ProgramWithdrawInfo
      //var instance = new CoreApiV10.ProgramWithdrawInfo();
      //expect(instance).to.be.a(CoreApiV10.ProgramWithdrawInfo);
    });
