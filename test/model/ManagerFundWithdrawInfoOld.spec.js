...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.ManagerFundWithdrawInfoOld();
  });
  ...
  describe('ManagerFundWithdrawInfoOld', function() {
    it('should create an instance of ManagerFundWithdrawInfoOld', function() {
      // uncomment below and update the code to test ManagerFundWithdrawInfoOld
      //var instane = new CoreApiV10.ManagerFundWithdrawInfoOld();
      //expect(instance).to.be.a(CoreApiV10.ManagerFundWithdrawInfoOld);
    });
