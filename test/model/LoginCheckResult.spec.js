...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.LoginCheckResult();
  });
  ...
  describe('LoginCheckResult', function() {
    it('should create an instance of LoginCheckResult', function() {
      // uncomment below and update the code to test LoginCheckResult
      //var instane = new CoreApiV10.LoginCheckResult();
      //expect(instance).to.be.a(CoreApiV10.LoginCheckResult);
    });
