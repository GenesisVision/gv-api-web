...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.WithdrawInfo();
  });
  ...
  describe('WithdrawInfo', function() {
    it('should create an instance of WithdrawInfo', function() {
      // uncomment below and update the code to test WithdrawInfo
      //var instane = new CoreApiV10.WithdrawInfo();
      //expect(instance).to.be.a(CoreApiV10.WithdrawInfo);
    });
