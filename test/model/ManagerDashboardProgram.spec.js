...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.ManagerDashboardProgram();
  });
  ...
  describe('ManagerDashboardProgram', function() {
    it('should create an instance of ManagerDashboardProgram', function() {
      // uncomment below and update the code to test ManagerDashboardProgram
      //var instane = new CoreApiV10.ManagerDashboardProgram();
      //expect(instance).to.be.a(CoreApiV10.ManagerDashboardProgram);
    });
