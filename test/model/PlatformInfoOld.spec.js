...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.PlatformInfoOld();
  });
  ...
  describe('PlatformInfoOld', function() {
    it('should create an instance of PlatformInfoOld', function() {
      // uncomment below and update the code to test PlatformInfoOld
      //var instane = new CoreApiV10.PlatformInfoOld();
      //expect(instance).to.be.a(CoreApiV10.PlatformInfoOld);
    });
    ...
    it('should have the property programCurrencies (base name: "programCurrencies")', function() {
      // uncomment below and update the code to test the property programCurrencies
      //var instane = new CoreApiV10.PlatformInfoOld();
      //expect(instance).to.be();
    });
