...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoreApiV10.InternalTransferRequest();
  });
  ...
  describe('InternalTransferRequest', function() {
    it('should create an instance of InternalTransferRequest', function() {
      // uncomment below and update the code to test InternalTransferRequest
      //var instance = new CoreApiV10.InternalTransferRequest();
      //expect(instance).to.be.a(CoreApiV10.InternalTransferRequest);
    });
