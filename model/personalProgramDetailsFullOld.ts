...
export class PersonalProgramDetailsFullOld { 
    ...
    static constructFromObject(data: {[key: string]: any}, obj: PersonalProgramDetailsFullOld = new PersonalProgramDetailsFullOld()): PersonalProgramDetailsFullOld {
        if (data) {
